...
import { ArrowLeft, Download, Github, Globe, Linkedin, Mail, Phone, RotateCcw, Shield, Twitter } from 'lucide-react';
    ...
    <div className='min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-700 p-4 relative'>
      <div className='absolute top-0 left-0 right-0 bg-gray-900/95 backdrop-blur-sm border-b border-gray-700 z-20'>
        <div className='max-w-4xl mx-auto px-6 py-4 flex items-center justify-center gap-4'>
          <img src='/images/hcmute-logo.png' alt='HCMUTE Logo' className='w-12 h-12 object-contain' />
          <div className='text-center'>
            <h1 className='text-xl font-bold text-white'>Ho Chi Minh City University of Technology and Education</h1>
      ...
      <div className='absolute top-6 right-6 z-10'>
        <Link href='/'>
          <Button
            variant='outline'
            className='gap-2 bg-gray-800/90 backdrop-blur-sm border-gray-600 text-gray-200 hover:bg-gray-700 shadow-lg'
          >
          ...
          >
                  ...
                  <div className='text-center mb-10'>
                    {contactInfo.photo ? (
                      <img
                        ...
                        className='w-28 h-28 rounded-full mx-auto mb-8 object-cover shadow-lg border-4 border-blue-500/30'
                      />
                    ) : (
                      <div className='w-28 h-28 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 rounded-full mx-auto mb-8 flex items-center justify-center text-white text-4xl font-bold shadow-lg'>
                        {contactInfo.name
                          .split(' ')
                          .map((n) => n[0])
                          .join('')
            ...
            <div className='absolute inset-0 backface-hidden rotate-y-180'>
              <Card className='w-full h-full bg-gradient-to-br from-gray-800 via-gray-700 to-gray-600 shadow-2xl border border-gray-600'>
                <CardContent className='p-12 h-full flex flex-col justify-center text-center'>
                  <div className='mb-8'>
                    <h3 className='text-3xl font-bold text-white mb-4'>Save to Contacts</h3>
                    <p className='text-gray-300 text-lg mb-8'>
                      Scan with your phone camera to instantly add this contact
                    </p>
                  </div>

                  <div className='bg-white p-8 rounded-xl shadow-inner mb-8 inline-block mx-auto'>
                    <QRCodeSVG value={generateVCard()} size={200} level='M' includeMargin={true} fgColor='#1f2937' />
                  </div>
      ...
      <div className='absolute bottom-0 left-0 right-0 bg-gray-900/95 backdrop-blur-sm border-t border-gray-700'>
        <div className='max-w-4xl mx-auto px-6 py-4'>
          <div className='flex items-center justify-center gap-3 text-gray-300'>
            ...
            <span className='text-sm font-medium'>This digital business card is verified and issued by HCMUTE</span>
            <div className='w-2 h-2 bg-green-400 rounded-full animate-pulse'></div>
          </div>
          <p className='text-center text-xs text-gray-400 mt-1'>Authenticated • Secure • Official</p>
        </div>
      </div>
